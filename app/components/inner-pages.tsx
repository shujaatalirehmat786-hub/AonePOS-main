...
export function SiteFooter() {
  return <div className="home-frame site-chrome"><footer className="hf-footer"><div className="hf-container">
    ...
    <div className="hf-footer-grid">
      <div><h3>Social Links</h3><div className="hf-social"><a href="https://www.linkedin.com/company/aoneposindia/home/" target="_blank" rel="noreferrer" aria-label="AOne POS on LinkedIn"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg></a><a href="https://www.facebook.com/AonePOSph/" target="_blank" rel="noreferrer" aria-label="AOne POS on Facebook"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a><a href="https://www.youtube.com/@AonePOS" target="_blank" rel="noreferrer" aria-label="AOne POS on YouTube"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a></div></div>
      ...
      <div className="hf-contact"><h3>Contact</h3><p><img src="/assets/footer-location.png" alt="" />2727 Lyndon B Johnson Fwy #1050, Dallas, TX 75234</p><p><img src="/assets/footer-location.png" alt="" />5755 Tenth Line W, Unit # 8, Mississauga, ON L5M0P7</p><p><img src="/assets/footer-phone.png" alt="" />+866-882-4292</p><p><img src="/assets/footer-email.png" alt="" />info@aonepos.com</p></div>
    </div>
...
export function FrameHero({active,eyebrow,title,highlight,text,image,stats,ctaPrimary="Book For Demo",ctaSecondary="See Pricing",secondaryHref="#details",dotBand=false,artFloats=false,artDots=false}: {active:string;eyebrow:string;title:string;highlight:string;text:string;image?:string;stats?:string[][];ctaPrimary?:string;ctaSecondary?:string;secondaryHref?:string;dotBand?:boolean;artFloats?:boolean;artDots?:boolean}) {
  return <><SiteHeader active={active}/><section className="frame-hero"><div className="inner-container frame-hero-grid">{dotBand&&<span className="hero-dot-band" aria-hidden="true"/>}<div><span className="inner-pill">{eyebrow}<Arrow/></span><h1>{title} <span>{highlight}</span></h1><p>{text}</p><div className="inner-hero-actions"><a className="inner-primary" href="/contact#contact-form">{ctaPrimary} <Arrow/></a><a className="inner-secondary" href={secondaryHref}>{ctaSecondary} <Arrow/></a></div>{stats&&<div className="frame-stats">{stats.map(([n,l])=><div key={l}><b>{n}</b><span>{l}</span></div>)}</div>}</div>{image&&(active==="products"?<div className="frame-hero-art-wrap"><img className="frame-hero-art frame-hero-art-products" src={image} alt=""/><img className="hero-decor-blob hero-decor-blob-a" src="/assets/why-ellipse-large.png" alt="" aria-hidden="true"/><img className="hero-decor-blob hero-decor-blob-b" src="/assets/why-ellipse-small.png" alt="" aria-hidden="true"/><img className="hero-decor-dots" src="/assets/why-dot-grid.png" alt="" aria-hidden="true"/>{artDots&&<img className="hero-art-dots" src="/assets/why-dot-grid.png" alt="" aria-hidden="true"/>}{artFloats&&<><img className="hero-art-card hero-art-payment" src="/assets/hero-payment-card.png" alt="" aria-hidden="true"/><img className="hero-art-card hero-art-chart" src="/assets/hero-assessment-chart.png" alt="" aria-hidden="true"/></>}</div>:<img className={`frame-hero-art${active==="about"?" frame-hero-art-about":""}`} src={image} alt=""/>)}</div></section></>;
}
